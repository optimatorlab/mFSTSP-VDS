...
1. A collection of **test problems (and solutions)** that were used in the analysis described in the [mFSTSP-VDS paper](https://ssrn.com/abstract=3549622).
   ...
   2. [`performance_summary.csv`](performance_summary.csv) provides information about solutions generated for each test problem in the [mFSTSP-VDS paper](https://ssrn.com/abstract=3549622). See the ["Archived Problem Solutions"](#Archived-Problem-Solutions) section below for details on the contents of this file.
...
2. A folder containing **source code** for the heuristic described in the [mFSTSP-VDS paper](https://ssrn.com/abstract=3549622).
